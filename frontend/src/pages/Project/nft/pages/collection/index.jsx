  ...
  render() {
    ...
    return (
      <div styleName="collection">
        ...
        <img alt="example" src={STATIC_IMG + listData?.bannerPath} />
        {/* <img alt="example" src={AJAX_PREFIXCONFIG + listData?.bannerPath} /> */}
        </div>
        <div styleName='people'>
        <img alt="example" src={STATIC_IMG + listData?.logoPath} />
        {/* <img alt="example" src={AJAX_PREFIXCONFIG + listData?.logoPath} /> */}
        </div>
        <div styleName='content'>
          <h2>{listData?.name}</h2>
          <p styleName='author'>符号标识&nbsp;&nbsp;<span>{listData?.symbol}</span></p>
          ...
          <div styleName='desc'>
            <Row>
              ...
              <Col span={6}>
                <h3>拥有者</h3>
                <p>{listData?.possessnum}</p>
              </Col>
              <Col span={6}>
                <h3>地板价</h3>
                <p>{listData?.lowPrice}</p>
              </Col>
              <Col span={6}>
                <h3>总交易额</h3>
                <p>{listData?.tradesum}</p>
              </Col>
            </Row>
          </div>
