...
export default class Header extends Component {
  ...
  leveOut = () =>{
    ...
    // 修改用户名
    // user.id="20230908095458693536608783";
    user.userName = '游客';
    // 将修改后的用户信息重新存储到 localStorage 中
  ...
  render() {
    ...
    const menu1 = (
      <Menu>
        ...
        <Menu.Item>
          <a rel="noopener noreferrer" href={`${preRouter}/login`}>登录
          </a>
        </Menu.Item>
        <Menu.Item>
                  ...
                  <Row>
                    ...
                    <Col span={12}>
                      <Dropdown overlay={menu1} placement="bottomCenter">
                        <a className="ant-dropdown-link" onClick={e => e.preventDefault()} style={{color:'#fff'}}>
                          {JSON.parse(localStorage.getItem('login-user')).userName}&nbsp;<DownOutlined />
