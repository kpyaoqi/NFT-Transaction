...
//import {nftRouterName,nftRouterNoLogin,nftRouter } from './mobile.nft.route' //nft路由

//不需要渲染框架的页面
export const noFrames = [
  // ...nftRouterName,//nft路由
  ...nftRouterName,//nftMobile路由
