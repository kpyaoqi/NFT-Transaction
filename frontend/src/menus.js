...
return ajax.post("api/system/user/menu").then((res) => {
    ...
    //     // { key: 'baidu', parentKey: 'other-site', text: '盛见', icon: 'ant-design', url: 'https://baidu.com', target: '', order: 2000 },
    ...
    //     // { key: 'baidu-family', basePath: 'http://baidu.com', text: '盛见全家桶', icon: 'DribbbleOutlined', order: 400 },
