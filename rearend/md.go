...
func main() {
	// 设置Hexo博客的目录路径
	mdDir := "C:/Users/zhuba/Desktop/md"
	noteimgDir := "C:/Users/zhuba/Desktop/noteimg"
	// 设置Markdown文件所在的目录路径
	...
	for _, file := range files {
		...
		if file.IsDir() {
			...
			if filepath.Ext(file.Name()) == ".md" {
				...
				tags := filepath.Base(markdownDir)
...
%s`, title, date, tags, tags, content)
				addTime(&date)
