...
const TableNameTAuditlogHistory2020 = "t_auditlog_history_2020"

// TAuditlogHistory2020 mapped from table <t_auditlog_history_2020>
type TAuditlogHistory2020 struct {
	...
	OperationTime    *time.Time `gorm:"column:operationTime;type:datetime" json:"operationTime"`          // 操作时间
...
// TableName TAuditlogHistory2020's table name
func (*TAuditlogHistory2020) TableName() string {
	return TableNameTAuditlogHistory2020
}
