...
type TPermissionsLog struct {
	...
	ActionType         *int64     `gorm:"column:actionType;type:int" json:"actionType"`                          // 操作类型 创建、编辑、删除、启用、禁用
	...
	OperatorObjectType *int64     `gorm:"column:operatorObjectType;type:int" json:"operatorObjectType"`          // 操作对象类型
	...
	CreateTime         *time.Time `gorm:"column:createTime;type:datetime" json:"createTime"`                     // 记录创建时间
