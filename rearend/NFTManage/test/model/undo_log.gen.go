...
type UndoLog struct {
	ID           int64     `gorm:"column:id;type:bigint;primaryKey;autoIncrement:true" json:"id"`    // increment id
	BranchID     int64     `gorm:"column:branch_id;type:bigint;not null" json:"branch_id"`           // branch transaction id
	...
	LogStatus    int64     `gorm:"column:log_status;type:int;not null" json:"log_status"`            // 0:normal status,1:defense status
