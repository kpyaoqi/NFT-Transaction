...
type NftWork struct {
	...
	WaitingTime   time.Time `gorm:"column:waitingTime;type:datetime;default:null" json:"waitingTime"`  // 发布等待期,日期之后才可购买
	ChainPlatCert string    `gorm:"column:chainPlatCert;type:json;default:{}" json:"chainPlatCert"`    // 上架后,在不同链平台上链,认证后的数据-json
