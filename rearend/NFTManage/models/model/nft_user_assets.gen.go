...
type NftUserAsset struct {
	...
	Type       int64     `gorm:"column:type;type:int(11);not null" json:"type"`             // 资源类型0:合集,1:作品
	Origin     int64     `gorm:"column:origin;type:int(11);not null" json:"origin"`         // 资产来源(0:自己创作,1购买其他作者)
	SellState  int64     `gorm:"column:sellState;type:int(11);not null" json:"sellState"`   // 出售状态,0:不出售,1:售卖中,2:已生成订单,3:已删除
