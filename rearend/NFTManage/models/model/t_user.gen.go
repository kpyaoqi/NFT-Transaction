...
type TUser struct {
	...
	Sex          string    `gorm:"column:sex;type:varchar(5);default:man" json:"sex"`               // 性别
	...
	UserType     int64     `gorm:"column:userType;type:int(11);not null;default:1" json:"userType"` // 0会员,1员工,2店长收银,9系统管理员
	...
	DeptId       string    `gorm:"-" json:"deptId"`
	Roles        []TRole   `gorm:"-" json:"roles"`
	OrgList      []TOrg    `gorm:"-" json:"orgList"`
}
