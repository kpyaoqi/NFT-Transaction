...
type TOrg struct {
	...
	OrgType      int64     `gorm:"column:orgType;type:int(11);not null" json:"orgType"`       // 0-99门店,100-199部门,200-299,分公司,300-399集团公司,900-999总平台
	...
	Children     []TOrg    `gorm:"-" json:"children"`
	ManagerType  int64     `gorm:"-" json:"managerType"`
}
